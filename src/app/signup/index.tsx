      ...
      <div className="flex w-[62%] items-start justify-center rounded-[16px] border-[7px] border-solid border-white-a700 bg-gray-50_01 p-2 md:w-full md:flex-col">
        <div className="mt-[22px] flex w-full flex-col items-start gap-9">
          ...
          <div className="flex flex-col gap-[58px] self-stretch sm:gap-[29px]">
            <div className="flex flex-col items-start gap-4">
              <div className="flex flex-col gap-2.5 self-stretch">
                <div className="flex gap-2.5">
                  <div className="flex w-[42%] flex-col items-start justify-center gap-1">
                  ...
                  <div className="flex flex-1 flex-col items-start justify-center gap-1">
                    ...
                    <Input shape="round" name="edittext_one" className="w-[76%] rounded-[18px] px-3" />
                  </div>
                </div>
                <div className="flex flex-col items-start justify-center gap-1">
                  <Heading size="texts" as="h3" className="text-[14px] font-medium !text-blue_gray-800">
                    E-mail
                  </Heading>
                  <Input shape="round" name="email" className="w-[86%] rounded-[18px] px-3" />
                </div>
                <div className="flex flex-col items-start justify-center gap-1">
                  <Heading size="texts" as="h4" className="text-[14px] font-medium !text-blue_gray-800">
                    Mot de passe
                  </Heading>
                  <Input shape="round" name="edittext_two" className="w-[86%] rounded-[18px] px-3" />
                </div>
                <div className="flex items-center justify-center">
                  <Img
                    src="img_buttonicon_checkfilled.svg"
                    width={24}
                    height={24}
                    alt="Buttonicon"
                    className="h-[24px]"
                  />
                  <div className="flex flex-1 flex-wrap gap-2.5 px-2.5">
                    <Text size="textxs" as="p" className="text-[12px] font-normal !text-black-900">
                      J’ai lu et J&#39;accepte les{" "}
                    </Text>
                    <Heading size="body_footer_bold" as="h5" className="text-[12px] font-bold !text-teal-900">
            ...
            <div className="mx-[50px] flex flex-wrap md:mx-0">
              <Text size="textxs" as="p" className="text-[12px] font-normal !text-black-900">
                Vous avez déjà un compte?
              </Text>
              <Heading size="body_footer_bold" as="h6" className="text-[12px] font-bold !text-teal-900">
                Se connecter
              </Heading>
            </div>
          </div>
